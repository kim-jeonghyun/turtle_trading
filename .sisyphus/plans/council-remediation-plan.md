...
**의존:** ~~Issue #11 (Direction enum 전환) 완료 후 진행~~ → **Issue #11 완료 (PR #46, 2026-02-23)**. Position.direction이 Direction enum으로 전환되어 가드 조건 자동 충족.
...
### Phase 2 완료 기준 — 대기
- [x] check_positions.py 커버리지: 97% 달성 — Issue #35, PR #45 (2026-02-23)
- [ ] Sortino ratio epsilon 수정 완료
- [x] Direction Enum 가드 적용 — Issue #11 완료 (PR #46, 2026-02-23)
- [ ] `--market` CLI 인자 추가 완료
