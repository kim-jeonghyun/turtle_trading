...
from src.notifier import DiscordChannel, EmailChannel, NotificationLevel, NotificationMessage, TelegramChannel
...
async def test_telegram():
    ...
    message = NotificationMessage(
        ...
        data={"시스템": "Turtle Trading v2.0", "상태": "정상"},
    )
...
async def main():
    ...
    results = {"Telegram": await test_telegram(), "Discord": await test_discord(), "Email": await test_email()}
